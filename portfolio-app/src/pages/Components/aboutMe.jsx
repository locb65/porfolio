...
export const AboutMe = () => {
    return (
        <div className='flex flex-col justify-center items-center mx-4 sm:mx-8 md:mx-12 lg:mx-20 px-4 sm:px-8 md:px-12 lg:px-20 h-screen w-screen'>
            ...
            <div className='flex flex-col sm:flex-row items-center content-center max-h-3/6'>
            <div className='flex flex-col items-center  w-full sm:w-2/6 mb-4 sm:mb-0 sm:mr-6 sm:border-r-2 sm:border-b-0 border-b-2 border-slate-400 p-4'>
                <img src={profilePic} alt="mePic" className='max-h-60 w-auto h-auto mr-6 rounded-3xl sm:max-h-96 md:max-h-80 sm:rounded-xl'/>
            </div>
            <div className='flex text-base sm:text-lg max-h-80 w-full sm:w-4/6 overflow-y-auto'>
